...
* the **rubric** is fixed, generic and config-owned (:mod:`crucible.evals.config`).
...
* the **task** is data (:mod:`crucible.evals.tasks`). A task file may carry a short
...
:mod:`crucible.evals.judge` runs that rubric through the same gateway contract the
