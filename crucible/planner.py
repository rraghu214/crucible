"""Capability-driven, outcome-by-outcome planning for Crucible.
...
from crucible.capabilities import GAP_FIELDS, CapabilityError, CapabilityRegistry
from crucible.core.live_graph import Event, GraphPatch, GraphSnapshot, TaskSpec
    ...
    async def plan(self, graph: GraphSnapshot, event: Event) -> GraphPatch:
        ...
        for attempt in range(self.repair_attempts + 1):
            ...
            try:
                ...
                meter = getattr(problem, "_crucible_planner_meter", {}) or {}
            ...
            meter = reply.pop("_crucible_planner_meter", {}) or {}
            metered_calls.extend(meter.get("metered_calls", []))
            budget_decisions.extend(meter.get("budget_decisions", []))
            ...
            try:
                ...
                if self.review_terminal and any(
                    ...
                    review_meter = review_reply.pop("_crucible_planner_meter", {}) or {}
