...
Each one is a thin delegate onto ``crucible.coding``: the rules live there, in
...
from crucible.coding import glob_files, grep_code, run_command
from crucible.coding.edit import apply_edit, copy_within_workspace, read_code
from crucible.coding.edit import create_file as coding_create_file
