...
from crucible.capabilities import CapabilityRegistry
from crucible.coding.edit import EditLedger
...
class RunContext:
    ...
    def workspace(self) -> Workspace:
        """Resolved per call: CRUCIBLE_WORKSPACE may legitimately differ per run."""
