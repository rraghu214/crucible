...
from crucible.core.memory import MemoryKind, MemoryRecord, Principal
from crucible.workers.context import RunContext
from crucible.workers.parsing import _parse_json_object
...
async def run_validate_work(ctx: RunContext, task: TaskSpec) -> dict[str, Any]:
    ...
    os.environ["_CRUCIBLE_VALIDATION_DEPTH"] = "1"
    try:
        ...
        os.environ.pop("_CRUCIBLE_VALIDATION_DEPTH", None)
