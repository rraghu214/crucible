...
CAPTURE_CONTENT_ENV = "CRUCIBLE_OTEL_CAPTURE_CONTENT"
ENDPOINT_ENV = "CRUCIBLE_OTEL_EXPORTER_ENDPOINT"
SERVICE_NAME_ENV = "CRUCIBLE_OTEL_SERVICE_NAME"
DEFAULT_SERVICE_NAME = "crucible"
...
def emit_span_tree(
    ...
    *,
    ...
    instrumentation_name: str = "crucible.telemetry",
) -> None:
