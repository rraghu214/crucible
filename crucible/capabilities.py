"""The complete capability surface exposed to the Crucible planner.
...
def default_registry() -> CapabilityRegistry:
    ...
    return CapabilityRegistry([
        ...
        # crucible/coding/, never asked for in a prompt.
        ...
        Capability("glob_files", "List workspace files whose path matches a pattern. Use this to scope before searching.",
                   {"pattern": string("Glob such as *.py or crucible/**.", maximum=500)},
